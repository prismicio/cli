...
import { upsertPrismicioRoutesConfig } from "../lib/pageType";
...
export const projectInit: ProjectInitHook<PluginOptions> = async (
	...
	// These must happen after the parallel init tasks since they depend on
	// files created above (prismicio.ts, slice library config).
	await upsertSliceLibraryIndexFiles(context);
	await upsertPrismicioRoutesConfig(context);
};
