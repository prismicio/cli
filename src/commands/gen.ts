...
export default createCommandRouter({
	...
	commands: {
		setup: { handler: genSetup, description: "Generate framework-specific Prismic setup" },
		"slice-index": {
			handler: genSliceIndex,
			description: "Generate the slice index file of each slice library",
		},
		types: { handler: genTypes, description: "Generate TypeScript types from local models" },
	},
});
